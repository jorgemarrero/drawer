...
function (_Component) {
  ...
  _createClass(DrawerBase, [{
    ...
    value: function render() {
      ...
      return ___EmotionJSX(Portal, {
        zIndex: "unset"
      }, ___EmotionJSX(TransitionGroup, {
        component: OnlyChild
      }, ___EmotionJSX(Fragment, null, ___EmotionJSX(Fade, {
        in: isOpen
      }, ___EmotionJSX(Blanket, {
        isTinted: true,
        onBlanketClicked: this.handleBlanketClick
      })), ___EmotionJSX(DrawerPrimitive, {
        icon: icon,
        in: isOpen,
